  ...
  return (
    <section className="relative overflow-y-visible">
      <div className="flex flex-col gap-y-3 mt-10 ml-10">
        ...
        <p className="mt-10 flex flex-col z-10 font-md indent-5 leading-loose">
          {paragraph}
        </p>
        <div className="text-primary mt-3 group flex hover:cursor-pointer items-center gap-x-4 transition duration-100 font-bold text-lg outline-2 outline-primary rounded-xl">
          {countryName} 준비 체크리스트 
          <MoveRight className="font-bold transition transform group-hover:translate-x-1 duration-150"/>
        </div>
      </div>
    </section>
  );
